...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body id="editor_popup">
    ...
    <table width="100%" cellpadding="5" cellspacing="0" border="0">
      ...
      <tr><td align="right">Stock #</td><td><input id="stock_input" name="stock" size="10"/></td></tr>
      <tr><td align="right">Color</td><td><input id="color_input" name="color" size="30"/></td></tr>
      <tr><td align="right">Engine</td><td><input id="engine_input" name="engine" size="30"/></td></tr>
      <tr><td align="right">Transmission</td><td><input id="transmission_input" name="transmission" size="30"/></td></tr>
      <tr><td align="right">Mileage</td><td><input id="mileage_input" name="mileage" size="10"/></td></tr>
      ...
      <tr><td colspan="2">Contact<br><textarea id="contact_input" name="contact" cols="60" rows="2"></textarea></td></tr>
    </table>
    ...
    <script type="text/javascript" charset="utf-8">
      ...
      function build_vehicle() {
        ...
        vehicle += '<p class="vehicle-detail">';
        ...
        vehicle += '</p>';
        vehicle += '<p class="vehicle-detail"><label>Description:</label><br><span id="description">' + document.getElementById('description_input').value + '</span></p>';
        vehicle += '<p class="vehicle-detail"><label>Equipment:</label><br><span id="equipment">' + document.getElementById('equipment_input').value + '</span></p>';
        if (document.getElementById('contact_input').value)
          vehicle += '<p class="vehicle-detail"><label>Contact:</label><br><span id="contact">' + document.getElementById('contact_input').value + '</span></p>';
        return vehicle;
      }
      
      function build_excerpt() {
        excerpt += '<p class="vehicle-listing">';
        ...
        excerpt += "<br>\n[permalink text='Click here for more info and photos']";
        excerpt += '</p>';
        return excerpt;
      }
